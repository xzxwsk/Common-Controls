      ...
      return firstPagePromise.then(function(pdfPage) {
        ...
        onePageRendered.then(function () {
          if (!PDFJS.disableAutoFetch) {
            ...
            console.log(getPagesLeft);
            console.log(pageView.viewport.height);
            if(getPagesLeft>1){
//            setIframeHeight((pageView.viewport.height+22) * pagesCount + 24, window.name);
			  setIframeHeight((pageView.viewport.height+32) * pagesCount + 20, window.name);
            }else{
              setIframeHeight(pageView.canvas.height+32, window.name);
            }
            for (var pageNum = 1; pageNum <= pagesCount; ++pageNum) {
